#!/usr/bin/env python3
"""
Placeholder AppIcon generator for LingoFloat.
...
Writes PNGs into LingoFloat/Assets.xcassets/AppIcon.appiconset/ and
...
APPICONSET = REPO_ROOT / "LingoFloat" / "Assets.xcassets" / "AppIcon.appiconset"
