...
enum PermissionsCoordinator {
    ...
    static let tccResetRescueText: String =
        ...
        Open Terminal and run:
            tccutil reset ScreenCapture com.whaledolphin.lingofloat && tccutil reset Microphone com.whaledolphin.lingofloat
        Then quit LingoFloat (⌘Q), relaunch, press Start, accept the fresh prompt, quit again, relaunch.
        """
}
