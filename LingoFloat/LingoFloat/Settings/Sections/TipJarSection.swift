...
private struct TipJarComposeCard: View {
    ...
    var body: some View {
        SettingsCard(
            title: "Buy the upstream author a coffee",
            footer: "This recipient belongs to the original WhisperCaption author, whose MIT-licensed work powers the first LingoFloat demo."
        ) {
