...
extension HUDDescriptor {
    ...
    static let mainHUDWindowIdentifierRaw = "LingoFloat.MainHUD"
}
...
extension HUDDescriptor {
    ...
    var showOnAllSpacesKey: String {
        "LingoFloat.settings.\(id)HUDShowOnAllSpaces"
    }
}
