...
final class MenuBarController {
    ...
    private func configureMenu() {
        ...
        let tipJarItem = NSMenuItem(title: "Support Upstream…", action: #selector(openTipJar), keyEquivalent: "")
        ...
        let quit = NSMenuItem(title: "Quit LingoFloat", action: #selector(quit), keyEquivalent: "q")
        quit.target = self
        menu.addItem(quit)
    }
    ...
    private func refresh() {
        ...
        if let button = statusItem?.button {
            button.image = NSImage(
                ...
                accessibilityDescription: "LingoFloat"
            )
