...
final class LingoFloatUITests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        let base = FileManager.default.temporaryDirectory
            .appendingPathComponent("LingoFloatUITest-\(UUID().uuidString)", isDirectory: true)
    ...
    override func tearDownWithError() throws {
        ...
        if let d = UserDefaults(suiteName: "com.whaledolphin.lingofloat") {
            d.removeObject(forKey: "LingoFloat.settings.activeChatID")
            d.removeObject(forKey: "LingoFloat.settings.mainHUDVisible")
        }
    }
